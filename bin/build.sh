...
cssdir='../styles'
htmldir='..'
target='toxquery toxcompound toxdataset toxstudy'
libs=()
tools=''
append=0
...
while (( "$#" )); do
	case $1 in
		...
		--help|-h)
			...
			echo "    [--target <kit list>]   : list of kits to be included. Omit jtoxkit. Default [toxquery toxcompound toxdataset toxstudy]."
