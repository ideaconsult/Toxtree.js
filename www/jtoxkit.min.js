...
kit=this;else
settings=jT.$.extend(settings,kit.settings,{baseUrl:kit.baseUrl});ccLib.fireCallback(settings.onConnect,kit,service);var accType=settings.plainText?"text/plain":(settings.jsonp?"application/x-javascript":"application/json");if(!params.data){params.data={};if(settings.jsonp)
