...
jT.$(theTable).dataTable().fnClearTable();return theTable;},processSummary:function(summary){var self=this;var typeSummary=[];jT.$('.jtox-study',self.rootElement).remove();summary.sort(function(a,b){return(a.category.description||a.category.title)<(b.category.description||b.category.title)?-1:1;});for(var si=0,sl=summary.length;si<sl;++si){var sum=summary[si];var top=sum.topcategory.title;if(!top)
