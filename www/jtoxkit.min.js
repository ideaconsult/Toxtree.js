...
return uri;}};return cls;})();var jToxSubstance=(function(){var defaultSettings={selectable:false,showControls:true,onLoaded:null,pageStart:0,pageSize:10,maxLength:0,configuration:{columns:{substance:{'Id':{sTitle:'Id',mData:'index',sDefaultContent:"-"},'Substance Name':{sTitle:"Substance Name",mData:"name",sDefaultContent:"-"},'Substance UUID':{sTitle:"Substance UUID",mData:"i5uuid",sClass:"shortened",sWidth:"20%",mRender:function(data,type,full){return(type!='display')?data:jT.ui.shortenedData(data,"Press to copy the UUID in the clipboard");}},'Composition Type':{sTitle:"Composition Type",mData:"substanceType",sDefaultContent:'-'},'Public name':{sTitle:"Public name",mData:"publicname",sDefaultContent:'-'},'Reference substance UUID':{sTitle:"Reference substance UUID",mData:"referenceSubstance",sClass:"shortened",sWidth:"20%",mRender:function(data,type,full){return(type!='display')?data.i5uuid:'<a target="_blank" href="'+data.uri+'">'+jT.ui.shortenedData(data.i5uuid,"Press to copy the UUID in the clipboard")+'</a>';}},'Owner':{sTitle:"Owner",mData:"ownerName",sDefaultContent:'-'},'Info':{sTitle:"Info",mData:"externalIdentifiers",mRender:function(data,type,full){var arr=[];for(var i=0,dl=data.length;i<dl;++i)
...
return html;if(typeof defs.selection=='function')
html+=defs.selection(data,type,full);else if(!!defs.selection)
...
"      <table></table>"+
"	  </div>"+
"";jT.templates['all-substance']="	  <div id=\"jtox-substance\">"+
"	    <div class=\"jtox-controls\">"+
"	      Showing from <span class=\"data-field from-field\" data-field=\"pagestart\"> ? </span> to <span class=\"data-field\" data-field=\"pageend\"> ? </span> in pages of <select class=\"data-field\" data-field=\"pagesize\">"+
"          <option value=\"10\" selected=\"yes\">10</option>"+
"          <option value=\"20\">20</option>"+
