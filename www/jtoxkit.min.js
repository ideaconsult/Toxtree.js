...
'/>'+oldRes;}};return cls;})();var jToxModel=(function(){var defaultSettings={selectable:false,selectionHandler:null,maxStars:10,algorithmFilter:true,sDom:"<Fif>rt",configuration:{columns:{model:{'Id':{iOrder:0,sTitle:"Id",mData:"id",sWidth:"50px",mRender:function(data,type,full){if(type!='display')
