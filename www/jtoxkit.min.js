...
fnComplete();}});},queryDataset:function(datasetUri){var self=this;self.clearDataset();self.init();var urlObj=ccLib.parseURL(datasetUri);if(urlObj.params['pagesize']!==undefined){var sz=parseInt(urlObj.params['pagesize']);if(sz>0)
