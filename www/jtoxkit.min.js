...
if(rlen>0)
$(self.fixTable).dataTable().fnSort([[1,"asc"]]);}}))[0];},updateTables:function(){var self=this;self.filterEntries($('.jtox-ds-control input',self.rootElement).val());},prepareGroups:function(){var self=this;var grps=self.settings.configuration.groups;self.groups={};for(var i in grps){var grp=grps[i];var grpArr=(typeof grp=="function")?grp(i,self.features):grp;self.groups[i]=grpArr;for(var i=0,glen=self.groups;i<glen;++i)
