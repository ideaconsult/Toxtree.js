...
self.settings.configuration.columns.dataset.Stars.sWidth="40px";if(self.settings.selectable){var oldFn=self.settings.configuration.columns.dataset.Id.mRender=jT.ui.addSelection(self,self.settings.configuration.columns.dataset.Id.mRender);self.settings.configuration.columns.dataset.Id.sWidth="60px";}
...
colDefs.push(col);}
this.sortColDefs(colDefs);return colDefs;},putStars:function(kit,stars,title){if(!kit.settings.shortStars){var res='<div title="'+title+'">';for(var i=0;i<kit.settings.maxStars;++i){res+='<span class="ui-icon ui-icon-star jtox-inline';if(i>=stars)
...
'/>'+oldRes;}}};jT.$=jQuery;jT.$(document).ready(function(){jT.init();});jT.templates['widget-search']="    <div id=\"jtox-search\" class=\"jtox-search\">"+
"      <form>"+
