...
return fEl;},function(id,parent){var tabTable=jT.getTemplate('#jtox-details-table');parent.appendChild(tabTable);return tabTable;});jT.$(cell).height(detDiv.offsetHeight);ccLib.fireCallback(self.settings.onDetails,self,detDiv,full,event);jT.$(cell).data('detailsDiv',detDiv);jT.$(detDiv).data('rootCell',cell);}
