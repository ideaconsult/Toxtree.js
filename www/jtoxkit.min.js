...
self.settings.configuration.columns.dataset.Stars.sWidth="40px";if(self.settings.selectable){self.settings.configuration.columns.dataset.Id.mRender=jT.ui.addSelection(self,self.settings.configuration.columns.dataset.Id.mRender);self.settings.configuration.columns.dataset.Id.sWidth="60px";}
...
return uri;}};return cls;})();var jToxModel=(function(){var defaultSettings={selectable:false,selectionHandler:null,maxStars:10,algorithmLink:true,algorithms:false,onLoaded:null,sDom:"<Fif>rt",loadOnInit:false,configuration:{columns:{model:{'Id':{iOrder:0,sTitle:"Id",mData:"id",sWidth:"50px",mRender:function(data,type,full){if(type!='display')
...
return res;};}
var cat=self.settings.algorithms?'algorithm':'model';if(self.settings.selectable){self.settings.configuration.columns[cat].Id.mRender=jT.ui.addSelection(self,self.settings.configuration.columns.model.Id.mRender);self.settings.configuration.columns[cat].Id.sWidth="60px";}
...
res+='<span class="jtox-details-open ui-icon ui-icon-circle-triangle-e" title="Press to open/close detailed info for this substance"></span>';return res;};if(self.settings.selectable){colId.mRender=jT.ui.addSelection(self,idFn);colId.sWidth="60px";}
else
