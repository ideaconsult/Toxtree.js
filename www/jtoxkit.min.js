...
self.entriesCount=qStart+qSize;if(self.settings.showControls){var pane=jT.$('.jtox-ds-control',self.rootElement)[0];ccLib.fillTree(pane,{"pagestart":qStart+1,"pageend":qStart+qSize,});var nextBut=jT.$('.next-field',pane);if(self.entriesCount===null||qStart+qSize<self.entriesCount)
...
return uri;}};return cls;})();var jToxComposition=(function(){var defaultSettings={selectable:false,showBanner:true,sDom:"rt<Ffp>",onLoaded:null,configuration:{columns:{composition:{'Type':{sTitle:"Type",sClass:"left",sWidth:"10%",mData:"relation",mRender:function(val,type,full){if(type!='display')
...
'/>';return html+oldRes;}}};jT.$=jQuery;jT.$(document).ready(function(){jT.init();});jT.templates['widget-search']="    <div id=\"jtox-search\" class=\"jtox-search\">"+
"      <form>"+
