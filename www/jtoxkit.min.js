...
break;if(features[feature.sameAs]!==undefined){feature=features[feature.sameAs];feature.originalId=fid;}
else{if(features[base+feature.sameAs]!==undefined){feature=features[base+feature.sameAs];feature.originalId=fid;}
else
break;}}
